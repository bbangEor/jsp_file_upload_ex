...
/**
 * 서블릿 스펙에서 파일 처리를 할려면 반드시 어노테이션 하나가 더 필요하다.
 */
@WebServlet("/upload")
...
public class FileUploadController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// C:\workweb_kda\jsp_file_upload_ex\src\main\webapp\images
		File uploadDirFile = new File("C:\\workweb_kda\\jsp_file_upload_ex\\src\\main\\webapp\\images");
